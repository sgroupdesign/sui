...
.btn-secondary:hover, .btn-secondary:focus, .btn-secondary:active {
	--tw-border-opacity: 1;
	border-color: rgba(39, 121, 120, var(--tw-border-opacity));
	--tw-bg-opacity: 1;
	background-color: rgba(39, 121, 120, var(--tw-bg-opacity));
	--tw-text-opacity: 1;
	color: rgba(255, 255, 255, var(--tw-text-opacity));
}
.btn-success {
...
.h1, .h2, .richtext h2, .h3, .richtext h3, .h4, .richtext h4, .h5, .richtext h5, .h6, .richtext h6 {
...
.link:hover, .richtext a:hover {
	--tw-text-opacity: 1;
	color: rgba(72, 82, 173, var(--tw-text-opacity));
}
.link:focus, .richtext a:focus, .link:active, .richtext a:active, .link:hover, .richtext a:hover {
	text-decoration: none;
	outline: 2px solid transparent;
	outline-offset: 2px;
}
...
.mobile-menu-toggle-open [data-mobile-menu-target] {
	visibility: visible;
	opacity: 1;
}
.mobile-menu-toggle-open [data-mobile-menu-target-pane] {
	--tw-translate-x: 0px;
	transform: var(--tw-transform);
}
/* Demo Styles */
