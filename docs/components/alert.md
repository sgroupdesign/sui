...
<code-preview heading="With close button">
    <alert class="rounded-md bg-green-50 p-4" role="alert" v-model:show="alertShownByDefault">
        <div class="flex">
            ...
            <div class="ml-auto pl-3">
                <div class="-mx-1.5 -my-1.5">
                    <alert-close class="inline-flex bg-green-50 rounded-md p-1.5 text-green-500 hover:bg-green-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-green-50 focus:ring-green-600">
